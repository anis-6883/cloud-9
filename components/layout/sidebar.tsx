...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      variant='ghost'
      size='icon'
      className={cn("border-primary size-7 border p-4 hover:text-white dark:border-white", className)}
      onClick={event => {
        onClick?.(event);
        toggleSidebar();
      }}
      {...props}
    >
      <PanelLeftIcon className='text-primary hover:text-white dark:text-white' />
